plotSignatures <- function(clus=null, col=col, cexlab=1.0, cexlegend=1.0)
{
	require(corrplot)
	...
	corrplot(t(DataMatrix), method="circle", order="original", addgrid.col="grey60", tl.col="black", col=col, cl.cex=cexlab, cl.pos="b", cl.ratio=0.4, cl.lim=c(-1,1), cl.length=3, tl.cex=cexlab, tl.srt=45, mar=c(1,2,1,2))
