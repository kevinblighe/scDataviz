...
In a practical situation, we would normally read in the data from the raw FCS
...
7500 cells using the above code. This data comes included with the package.
...
To see a full vignette that utilises the raw FCS files, see the
...
```{r ex1, fig.height = 7, fig.width = 8, fig.cap = 'Perform PCA'}
  ...
  biplot(p,
    ...
    caption = paste0('7500 cells randomly selected after ',
...
```{r ex6a, fig.height = 5, fig.width = 18, fig.cap = 'Plot marker expression per identified cluster1'}
...
```{r ex6c, fig.height = 6, fig.width = 20, fig.cap = 'Plot marker expression per identified cluster3'}
