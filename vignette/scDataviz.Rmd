...
# Tutorial 1: flow cytometry FCS data
...
Now, read in the data and normalise it
...
```{r readFCS, eval = FALSE}
  ...
  filelist <- list.files(
    ...
    pattern = "*.fcs|*.FCS",
    full.names = TRUE)
  filelist <- gsub('Arbore2020_Tcell_Complosome/', '', filelist)
  filelist
...
One can also create a new *SingleCellExperiment* object manually using any type of data, including any data-matrix from scRNA-seq produced elsewhere. Import functions for data deriving from popular programs will come, e.g., *Seurat*.
