...
```{r ex8, eval = FALSE, fig.height = 12, fig.width = 16, fig.cap = "SeuratToSCE: show marker expression across the layout"}
...
```{r ex9, eval = FALSE, message = FALSE, fig.height = 8, fig.width = 8, fig.cap = "SeuratToSCE: find ideal clusters in the UMAP layout via k-nearest neighbours"}
