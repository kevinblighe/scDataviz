...
```{r ex6a, fig.height = 10, fig.width = 18, fig.cap = "Plot marker expression per identified cluster1"}
...
```{r ex6b, fig.height = 10, fig.width = 16, fig.cap = "Plot marker expression per identified cluster2"}
